...
info_sites_ARCHIVE_temp <- search_database("archive", "V10|V25", extra = TRUE) %>% ### sites where external temperature is measured (TEOM-FDMS) 
    filter(site_friendly == site_code,
           variable_friendly %in% c("v10", "v25"))
